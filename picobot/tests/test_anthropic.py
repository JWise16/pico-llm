...
print("ANTHROPIC_API_KEY value:", os.getenv("ANTHROPIC_API_KEY", "Not set")[:5] + "..." if os.getenv("ANTHROPIC_API_KEY") else "Not set")
...
def main():
    ...
    bot = SimplePicobot()
    provider = AnthropicProvider(model="claude-3-sonnet", temperature=0.7)
